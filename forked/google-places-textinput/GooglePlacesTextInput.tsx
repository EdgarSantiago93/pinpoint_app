  ...
  (
    ...
    const handleBlur = (event: BlurEvent): void => {
      ...
      setTimeout(() => {
        ...
        // Keep suggestions visible even when blurring the input
        // setShowSuggestions(false);
      }, 10);
    };
                ...
                <View style={styles.clearTextWrapper}>
                  <Text
                    style={[
                      ...
                      style.clearButtonText as TextStyle,
                    ]}
...
GooglePlacesTextInput.displayName = 'GooglePlacesTextInput';
...
const styles = StyleSheet.create({
  ...
  inputWrapper: {
    // Static wrapper for input - doesn't flex
  },
  input: {
    borderRadius: 6,
    borderWidth: 1,
